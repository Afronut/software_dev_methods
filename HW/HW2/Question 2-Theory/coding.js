function display2_1() {
  var myanswer = "- The first display undefined because the dictionary does not have a key value draginball - null==undefined because they have the same true value in javascript which is false - in this context, the string null is not equal to the string undefined " // TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}

function display2_2() {
  var myanswer = "The code goes to strict mode that is undeclared variable can not be used" // TODO 2.2: Fill in Answer here
  document.getElementById("22answer").innerHTML = myanswer; // Do not change
}

function display2_5() {
  var myanswer = "Because their display has been set to none" // TODO 2.5: Fill in Answer here
